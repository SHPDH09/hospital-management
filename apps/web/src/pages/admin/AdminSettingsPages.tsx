...
const categoryFields: Record<string, { title: string; fields: FieldDef[] }> = {
  ...
  security: {
    ...
    fields: [
      ...
      { key: 'resetTokenExpiryMinutes', label: 'Reset Token Expiry (minutes)', type: 'number' },
      { key: 'passwordReuseLimit', label: 'Password Reuse Limit (last N)', type: 'number' },
      { key: 'passwordResetRateLimitPerHour', label: 'Reset Requests Per Hour', type: 'number' },
      { key: 'invalidateSessionsOnReset', label: 'Invalidate Sessions After Reset', type: 'toggle' },
