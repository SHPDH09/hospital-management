...
import crmReferralRoutes from './routes/crm/referrals';
...
import patientReviewRoutes from './routes/patient-reviews';
...
app.use('/api/v1/crm/referrals', crmReferralRoutes);
app.use('/api/v1/referral-portal', referralPortalRoutes);
app.use('/api/v1/patient/reviews', patientReviewRoutes);
